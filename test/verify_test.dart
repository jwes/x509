...
void main() {
  test('test verify a single cert from pem', () async {
    /// this is currently the only way that works
    var caPem = await File("test/resources/ca.cert.pem").readAsString();
    var toCheckPem = await File("test/resources/toCheck.cert.pem").readAsString();
